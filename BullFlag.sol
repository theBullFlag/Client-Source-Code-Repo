...
interface IRouter01 {
    ...
    function addLiquidityETH(
        ...
        address to,
        uint deadline
    ) external payable returns (uint amountToken, uint amountETH, uint development);
    function addLiquidity(
        ...
        address to,
        uint deadline
    ) external returns (uint amountA, uint amountB, uint development);
...
contract BullFlag is IERC20 {
    ...
    string constant private _name = "Bull Flag";
    string constant private _symbol = "BFL";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x6D586214A01f2a0A068be9Ac1E49C3a5B39D3B75),
        development: payable(0xF9334A8b5e54581CF272F24a685583Be9d0De9Df),
        buyback: payable(0xCf54E5Fa632659565b0e330ABd5Ff03536fAf92d)
    });
...
//===============================================================================================================
    ...
    function setNewRouter(address newRouter) external onlyOwner {
        require(!_hasLiqBeenAdded, "Cannot change after development.");
    ...
    function setRatios(uint16 buyback, uint16 development, uint16 marketing, uint16 burn) external onlyOwner {
    ...
    function sweepContingency() external onlyOwner {
        require(!_hasLiqBeenAdded, "Cannot call after development.");
    ...
    function finalizeTransfer(address from, address to, uint256 amount, bool buy, bool sell, bool other) internal returns (bool) {
        ...
        if (!_hasLiqBeenAdded) {
            ...
            if (!_hasLiqBeenAdded && _hasLimits(from, to) && !_isExcludedFromProtection[from] && !_isExcludedFromProtection[to] && !other) {
                revert("Pre-development transfer protection.");
            }
        }
        return true;
    }
