...
contract SHISHOKUINU is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**9 * (10**9); 

    uint256 public maxBuyAmount = 2 * 10**13 * 10**9; // 1% of the supply
    uint256 public maxSellAmount = 1 * 10**13 * 10**9; // 1% of the supply
    uint256 public maxWalletAmount = 5 * 10**13 * 10**9; // 5% of the supply
    ...
    address payable _marketingWallet = payable(address(0xE2DF772940dA825f478678ECBCd12a1ff99ed605)); // MarketingWallet
    ...
    constructor() ERC20("Shishoku Inu", "SHISHOKU") {
        ...
        */
        _mint(owner(), 1 * 10**15 * (10**9)); //  1 QuadTrillion Tokens
    }
